export const guidedMeditations = {
  welcome: {
    ...
    content: `Welcome to this calming meditation by Connected Innergy.

Find a comfortable place where you can sit or lie down, and allow yourself a few moments to settle in. Gently close your eyes, and take a deep breath in through your nose… slowly… letting your lungs fill with fresh, calming air. Hold it for a moment at the top… and then exhale slowly through your mouth, releasing any tension.`,
    duration: 30,
  },
  breathing: {
    title: "Deep Breathing",
    content: `As you continue breathing, allow your breath to deepen, becoming smooth and steady. Inhale deeply… feeling the breath fill your body with calm and peace… and then exhale fully, letting go of any worries, any distractions, any thoughts that do not serve you in this moment. Feel the weight of the world lifting off your shoulders with each breath.`,
    duration: 45,
  },
  visualization: {
    title: "Peaceful Garden",
    content: `Picture yourself in a peaceful place.
Imagine you're in a quiet, serene garden—lush and green, with the gentle sound of a breeze rustling through the leaves. The sun is shining softly, warming your skin just enough to make you feel comfortable. The air smells fresh, like flowers and earth. You can hear the faint sound of a stream flowing nearby, its gentle waters creating a rhythm that calms your mind.`,
  ...
  deepening: {
    title: "Deepening Peace",
    content: `Let your mind drift into this peaceful moment.
With each breath, allow yourself to feel more grounded, more centered, as though you are connected to this peaceful place. Visualize each breath flowing in and out like the rhythm of the stream, steady and calming. As you exhale, feel any tension or stress dissolving away, leaving only a sense of deep calm and relaxation.`,
    duration: 45,
  },
  affirmations: {
    title: "Positive Affirmations",
    content: `Now, with each breath, repeat to yourself these affirmations:
...
As you breathe, feel your heart expand with gratitude, with acceptance, with love. Your body is at ease, your mind quiet, your spirit at peace.`,
  ...
  completion: {
    title: "Gentle Return",
    content: `Allow any remaining tension to melt away, and take a moment to enjoy the stillness. Know that in this moment, you are safe, you are at peace, and all is well.
...
export type MeditationStep = keyof typeof guidedMeditations;